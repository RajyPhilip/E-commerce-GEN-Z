...
export const updateProduct =(id,productData)=> async(dispatch)=>{
    try {
        ...
        const {data} = await axios.put(`/api/v1/products/update/${id}`,productData,config);
...
export const deleteProduct =(id)=> async(dispatch)=>{
    try {
        ...
        const {data} = await axios.put(`/api/v1/products/delete/${id}`);
...
//getting product details action
...
export const deleteReview =(reviewId,productId)=> async(dispatch)=>{
    try {
        ...
        const {data} = await axios.delete(`/api/v1/allreviews?id=${reviewId}&productId=${productId}`);
